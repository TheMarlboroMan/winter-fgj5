...
class Kernel_app:public Kernel_base
{
	...
	virtual std::string acc_titulo_inicial() const {return std::string("WINTER");}
	...
	virtual unsigned int acc_recurso_fps() const {return App::Recursos_graficos::rs_fuente_peq;}
};
