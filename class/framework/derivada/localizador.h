...
class Localizador:public Herramientas_proyecto::Localizador_base
{
	...
	virtual Herramientas_proyecto::t_cadena const& cadena_no_cargado() const {return c_no_cargado;}
	virtual Herramientas_proyecto::t_cadena const& cadena_no_encontrado() const {return c_no_encontrado;}
